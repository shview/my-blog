...
updated: '2026-03-14T18:15:02.008+08:00'
---
...
下载完成后解压，里面还有一个压缩包，解压，若为pixel7以前，找boot.img，若为pixel7及以后，找init_boot.img，传到手机里用Magisk修补，修补后传回电脑，进入fastboot。若为pixel7以前的，输入

~~~
fastboot flash boot "文件路径"
~~~

若为pixel7及以后，输入

~~~
fastboot flash init_boot "文件路径"
~~~

重启后进入Magisk选择直接安装就可以了。

重启后进入Magisk若“当前”显示版本号就说明成功了。
